                    ...
                    <?php if ($_SESSION['role'] !== 'patient'): ?>
                        <div class="mb-3">
                            ...
                            <select name="patient_id" class="form-select" required>
                                ...
                                <?php foreach ($controller->getPatientsList() as $patient): ?>
...
<div class="modal fade" id="editReadingModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit Pencatatan Tekanan Darah</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="../Controllers/PencatatanController.php" method="POST">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Systolic (mmHg)</label>
                        <input type="number" class="form-control" name="systolic" id="edit_systolic" required min="0"
                            max="300">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Diastolic (mmHg)</label>
                        <input type="number" class="form-control" name="diastolic" id="edit_diastolic" required min="0"
                            max="200">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Detak Jantung (bpm)</label>
...
<!-- View Reading Modal -->
<div class="modal fade" id="viewReadingModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Detail Pencatatan Tekanan Darah</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="mb-3">
